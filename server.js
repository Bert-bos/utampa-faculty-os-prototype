...
function signInPage(next, error = false) {
  const alert = error ? '<p id="auth-error" class="error" role="alert" aria-live="assertive" aria-atomic="true" tabindex="-1">We could not complete sign-in. Please try again with the authorized University account.</p>' : "";
